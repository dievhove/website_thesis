...
document.addEventListener("DOMContentLoaded", function () {
    ...
    createChart("yellow_chart", "Yellow pollen count", "yellow");
    createChart("orange_chart", "Orange pollen count", "orange");
    createChart("red_chart", "Red pollen count", "red");
    createChart("purple_chart", "Purple pollen count", "purple");
